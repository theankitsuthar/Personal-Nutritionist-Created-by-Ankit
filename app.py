...
st.set_page_config(page_title="Personal Nutritionist Created by Ankit")
...
st.header("Personal Nutritionist Created by Ankit")
...
and calculate the total calories,protein . Provide details of every food item with calorie intake
...
""", unsafe_allow_html=True)
    # Add your name to the Streamlit layout
# Add your name to the Streamlit layout with bold and red color
st.sidebar.markdown("<p style='color:red; font-weight:bold;'>Created by: Ankit</p>", unsafe_allow_html=True)
# Add instructions for using the app
st.sidebar.markdown("### Instructions:")
st.sidebar.markdown("1. Upload an image containing food items.")
st.sidebar.markdown("2. Enter any additional query or request (optional).")
st.sidebar.markdown("3. Click the 'Analyze Image' button to get nutrition analysis.")
